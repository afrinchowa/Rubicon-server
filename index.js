...
// middleware
// const corsConfig = {
//   origin: ["https://bistro-boss-634b2.web.app"],
//   credentials: true,
...
async function run() {
  try {
    ...
    const cartCollection = client.db("Rubicon").collection("carts");
    const userCollection = client.db("Rubicon").collection("users");
    const paymentCollection = client.db("Rubicon").collection("payments");
    ...
    app.get("/admin-stats",verifyToken,verifyAdmin, async (req, res) => {
      ...
      // const revenue = paymentCollection.reduce(
